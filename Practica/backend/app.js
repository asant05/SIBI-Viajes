...
app.get("/buscandoSitios", function(req, res) {
  ...
  //if(req.query.costaInterior!=undefined){
    //query+=" AND s.costaInterior='"+req.query.costaInterior+"'"
  //}
  /*if(req.query.ruralUrbano!=undefined){
    query+= " AND s.ruralUrbano="+req.query.ruralUrbano+""
  }
  if(req.query.descansoTurismo!=undefined){
    query+= " AND s.descansoTurismo="+req.query.descansoTurismo+""
  }
  if(req.query.monumentos!=undefined){
    query+= " AND s.monumentos>"+req.query.monumentos+""
  }
  if(req.query.naturaleza!=undefined){
    query+= " AND s.naturaleza>"+req.query.naturaleza+""
  }
  if(req.query.comida!=undefined){
    query+= " AND s.comida>"+req.query.comida+""
  }
  if(req.query.fiesta!=undefined){
  ...
  query+=" RETURN s.nombre, p.nombre, c.nombre, s.costaInterior, s.ruralUrbano, s.descansoTurismo, s.monumentos, s.naturaleza, s.comida, s.fiesta"
  //query+=" RETURN s.nombre, s.monumentos "
